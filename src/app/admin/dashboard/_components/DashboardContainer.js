    ...
    <div className="space-y-20">
      ...
      <section className="grid grid-cols-2 gap-5 md:grid-cols-3 2xl:grid-cols-3">
        {userStats?.map((stat) => (
          <div
            key={stat.key}
            className="gap-x-4 rounded-2xl bg-[#FFFFFF] p-5 text-black shadow-lg"
          >
            <div className="flex justify-between gap-4">
              ...
              <div className="flex items-center justify-center rounded-full bg-[#F5F5F5] p-5">
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#E47637] p-2">
                  {stat.icon}
                </div>
              </div>
            </div>
